...
const DEBUG_CONSTANTS = {
	...
	USE_MINIMAL_PLANT_BED_SCENE: true,
	MINIMAL_SCENE_SPLAT_URL: 'assets/splats/environment.spz',
	MINIMAL_SCENE_SPLAT_SCALE: 1.8,
	MINIMAL_SCENE_SPLAT_ENABLE_LOD: false,
	MINIMAL_SCENE_SPLAT_LOD_SCALE: 1.0,
	KEEP_ONLY_FLOOR: true,
	FLOOR_SCENE_OBJECT_PATTERNS: ['Mainland', 'Cliff_Surface', 'Road'],
	DISABLED_SCENE_OBJECT_PATTERNS: [
		'Bench.gltf',
		'Cliff_Boundary',
		'Cliff_Surface',
		'Flora_Bush_07',
		'Flora_BushClusters_01_Flora_BaseColor',
		'Flora_BushClusters_01_Flora_OcclusionRoughnessMetallic',
		'M_Flora',
		'M_Prop_Fountain_Water',
		'M_Prop_PineTrees',
		'M_Road',
		'M_Rock',
		'M_Rock_02',
		'M_Rock_02_Underwater',
		'M_Rock_02b',
		'M_Rockwall',
		'M_Underwater_Landscape_Sand',
		'M_Underwater_Rockwall',
		'Mainland',
		'Outer_Boundary',
		'Player_Start',
		'Pond_Boundary_1',
		...
		'PondBoundingRegion',
		'Prop_Bridge.gltf',
		'Prop_Fence_01_01.gltf',
		'Prop_Fence_01_03.gltf',
		'Prop_Fence_01_04.gltf',
		'Prop_Fountain.gltf',
		'Prop_Gate.gltf',
		'Prop_Gazebo.gltf',
		'Prop_Pergola.gltf',
		'Prop_Planter_Circular_01.gltf',
		'Prop_Planter_Circular_02.gltf',
		'Prop_Planter_Long02.gltf',
		'Prop_Planter_Long04.gltf',
		'Prop_Sky.gltf',
		'River_Boundary_1',
		'River_Boundary_2',
		'River_Surface',
		...
		'water_ocean',
		'water_pond',
	], // matches node names, linked asset ids, or material names in the environment
	...
	DISABLE_WATER_FAUNA: true,
	DISABLE_AIR_FAUNA: true,
};
